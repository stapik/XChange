...
import dto.KucoinWebSocketSubscriptionMessage;
...
import dto.response.KucoinWebSocketResponse;
...
public class KucoinStreamingService extends JsonNettyStreamingService {
  ...
  public KucoinStreamingService(String apiUri, ExchangeSpecification exchangeSpecification) {
    super(apiUri, Integer.MAX_VALUE);
    this.apiUri = apiUri;
    this.exchangeSpecification = exchangeSpecification;
  }

  public Observable<KucoinWebSocketResponse> getRawWebSocketTransactions(
            ...
            msg -> {
              switch (channelName) {
                case SPOT_ORDERBOOK_CHANNEL:
                  return mapper.readValue(msg.toString(), KucoinOrderBookResponse.class);
                case SPOT_TICKERS_CHANNEL:
                  return mapper.readValue(msg.toString(), KucoinTickerResponse.class);
                case SPOT_TRADES_CHANNEL:
                  return mapper.readValue(msg.toString(), KucoinTradeResponse.class);
              }
              return mapper.readValue(msg.toString(), KucoinWebSocketResponse.class);
            })
  ...
  public String getSubscribeMessage(String channelName, Object... args) throws IOException {
    ...
    KucoinWebSocketSubscriptionMessage subscribeMessage =
        new KucoinWebSocketSubscriptionMessage(
  ...
  public String getUnsubscribeMessage(String channelName, Object... args) throws IOException {
    KucoinWebSocketSubscriptionMessage unsubscribeMessage =
        objectMapper.readValue(
            channelSubscriptionMessages.get(channelName), KucoinWebSocketSubscriptionMessage.class);
